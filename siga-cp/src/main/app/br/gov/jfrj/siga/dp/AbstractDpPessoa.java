...
@MappedSuperclass
@NamedNativeQuery(name = "consultarDataEHoraDoServidor", query = "SELECT CURRENT_TIMESTAMP AS \"dt\"", resultSetMapping = "scalar")
@NamedQueries({
		...
		@NamedQuery(name = "consultarPorFiltroDpPessoa", query = "from DpPessoa pes "
				...
				+ "	and (:situacaoFuncionalPessoa = '' or :situacaoFuncionalPessoa = null or pes.situacaoFuncionalPessoa = :situacaoFuncionalPessoa)"
