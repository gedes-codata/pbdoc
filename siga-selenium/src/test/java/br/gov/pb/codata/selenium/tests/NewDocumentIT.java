...
public class NewDocumentIT extends DriverBase {
	...
	// Objetivo: Criar novos documentos para teste
	...
	private String classificationNumber = "01.03.02.03";
	...
	public void newDispatchDocument() throws Exception {
		...
		newDocumentPage.fillDescriptionTextarea("Texto de descricao para despacho");
		...
		editDocument.edit(Dictionary.ANOTAR);
		editDocument.edit(Dictionary.ANEXAR);
		editDocument.edit(Dictionary.DEFINIR_ACOMPANHAMENTO);
	...
	public void newLegalDocument() throws Exception {
		...
		newDocumentPage.selectReceiver(Dictionary.CAMPO_LIVRE);
