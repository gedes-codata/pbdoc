	...
	<ul class="dropdown-menu">
		...
		<li class="dropdown-submenu"><a href="javascript:void(0);"
			...
			<ul class="dropdown-menu">
				...
				<c:if test="${!('ZZZ'.equals(titular.orgaoUsuario.sigla))}">
		...
		<li><c:choose>
				...
				<c:otherwise>
					<a class="dropdown-item" id="apostilaSiga"
						href="https://portal.pbdoc.pb.gov.br/pasta-de-arquivos/manual-operacional-pbdoc.pdf" target="_blank">Apostila PBdoc</a>
