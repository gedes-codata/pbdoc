			...
			<div class="card bg-light mb-3">
				...
				<div class="card-body">
					<div class="row">
						<div class="col-sm-6">
							<div class="form-group">
								<label>Órgão</label> <select name="idOrgaoUsu"
									value="${idOrgaoUsu}" class="form-control">
					...
					<div class="row">
						<div class="col-sm">
							<div class="form-group">
								<input value="Pesquisar" class="btn btn-primary"
									onclick="javascript: sbmt(0);" />
							</div>
						</div>
					</div>
				</div>
			...
			<table border="0" class="table table-sm table-striped">
				...
				<tbody class="table-bordered">
					<siga:paginador maxItens="15" maxIndices="10"
						totalItens="${tamanho}" itens="${itens}" var="cargo">
						<tr>
							<td align="left">${cargo.descricao}</td>
							<td align="left"><c:url var="url" value="/app/cargo/editar">
