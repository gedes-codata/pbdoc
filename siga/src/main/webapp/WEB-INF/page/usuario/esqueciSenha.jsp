...
<script src="${pageContext.request.contextPath}/javascript/cpf-mask.js"></script>
...
function submeterRecuperacaoSenhaPrevinindoMultiplosClicks(form, metodo) {
	const submit = $('button#recuperarSenhaSubmitBtn');
	submit.attr('disabled', 'disabled');

	const isValid = validateUsuarioForm(form, metodo);
	if (!isValid) {
		setTimeout(() => submit.removeAttr('disabled'), 2000);
	}
	return isValid;
}
		...
		<div class="card bg-light mb-3" >
			...
			<div class="card-body">
				...
				<div class="card bg-white" >
					<div class="mx-2 mb-2" >
						<form action="${proxima_acao}" onsubmit="return submeterRecuperacaoSenhaPrevinindoMultiplosClicks(this, 'Met1');" method="post">
							<input type="hidden" name="usuario.metodo" value="1" />
							<input type="hidden" name="usuario.page" value="1" />
							<div class="row">
								<div class="col-sm-3">
									<div class="form-group">
										<label for="usuario.matricula">Usuário</label>					
							...
							<div id="painel-dados-usuario">
								<div class="row">
									<div class="col-sm-3">
										<div class="form-group">
											...
											<input name="usuario.cpf" onkeyup="this.value = cpfMask(this.value)" type="text" class="form-control" autocomplete="off" />
										</div>
									</div>
								</div>
								...
								<div class="row">
									<div class="col-sm-1">
										<button id="recuperarSenhaSubmitBtn" type="submit" class="btn btn-primary">OK</button>
									</div>
								</div>					
							</div>					
							<p  class="oculto"></p>
