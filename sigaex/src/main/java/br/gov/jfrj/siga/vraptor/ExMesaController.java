...
public class ExMesaController extends ExController {
	...
	public ExMesaController(HttpServletRequest request, HttpServletResponse response, ServletContext context, Result result, SigaObjects so, EntityManager em) {
	...
	public void json() throws Exception {
		SortedSet<br.gov.jfrj.siga.ex.bl.Mesa.MesaItem> itensMesa = Mesa.getMesa(dao(), getTitular(), getLotaTitular());

		String s = ExAssinadorExternoController.gson.toJson(itensMesa);
