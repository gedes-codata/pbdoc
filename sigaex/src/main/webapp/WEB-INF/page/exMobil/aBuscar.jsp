						...
						<div class="form-group col-md-3">
							<label for="dtDocFinalString">Data Final</label> <input
								...
								<div class="row">
									<div class="col-sm-6">
										<div class="form-group">
											<label>Assunto/Classificação</label>	
											<siga:selecao titulo="Assunto/Classificação:" propriedade="classificacao" tema="simple" modulo="sigaex" urlAcao="buscar" urlSelecionar="selecionar"/>
										</div>
									</div>
								</div>	
