...
<siga:pagina titulo="Lista de Expedientes" popup="${popup}" onLoad="init()">
	<div class="container-fluid content mb-3">
		<c:if
			...
			<c:if test="${(empty tamanho or tamanho == 0) and errormsg == null}">
				<h2 class="mt-3"><fmt:message key="documento.encontrados"/></h2>
				...
				<form id="listar" name="listar"
					...
					<div class="form-row">
						...
						<div class="form-group col-md-2">
							...
							<select class="form-control" id="ultMovTipoResp" name="ultMovTipoResp"
					...
					<c:if test="${siga_cliente != 'GOVSP'}">
						<div class="form-row">
							<div class="form-group col-md-6">
								...
								<input	id="descricao" class="form-control" type="text" name="descrDocumento"
									value="${descrDocumento}" size="80" />
							</div>
						</div>
					</c:if>
