...
<siga:pagina titulo="Movimentação" compatibilidade="IE=EmulateIE9">
	...
	<script type="text/javascript" language="Javascript1.1">
		...
		function validaSelecaoAnexo(form) {
	        ...
	        if(tamanhoArquivo > (10 * 1024 * 1024)){ 
	            alert("Não é permitida a anexação de arquivos com mais de 10MB.");
	            return false;
	        }
							...
							<div class="col-sm-12">
								<div class="form-group">
									<label>Arquivo:</label> <input class="form-control" type="file"
										id="arquivo" name="arquivo" accept="application/pdf"
											...
											<c:forEach var="acao" items="${mov.acoes}">
												<c:choose>
													<c:when test='${mov.idTpMov == 32}'>
														<c:url var="url" value="${acao.nameSpace}">
	...
	<div id="dados-assinatura" style="display: none">
		...
		<tags:assinatura_botoes assinar="true" assinarComSenha="${f:podeAssinarMovimentacaoDoMobilComSenha(titular,lotaTitular,mob)}" />

<!--
	Atenticar removido por não haver a necessidade de uso imediato
