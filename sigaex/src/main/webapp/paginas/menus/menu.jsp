	...
	<c:if
		...
		<li class="nav-item dropdown"><a href="javascript:void(0);"
			...
			<ul class="dropdown-menu">
				...
				<c:if
					test="${f:podeUtilizarServicoPorConfiguracao(titular,lotaTitular,'SIGA:Sistema Integrado de Gestão Administrativa;DOC:Módulo de Documentos;FE:Ferramentas;PC:Plano de Assunto/Classificação')}">
					<li><a class="dropdown-item"
						href="/sigaex/app/expediente/classificacao/listar">Assunto/Classificação
							Documental</a></li>
				</c:if>
				<c:if
	...
	<c:if
		...
		<li class="nav-item dropdown"><a href="javascript:void(0);"
			...
			<ul class="dropdown-menu">
				...
				<c:if
					test="${f:podeUtilizarServicoPorConfiguracao(titular,lotaTitular,'SIGA:Sistema Integrado de Gestão Administrativa;DOC:Módulo de Documentos;REL:Gerar relatórios;CLSD:Assunto/Classificação Documental')}">
					<li class="dropdown-submenu"><a href="javascript:void(0);"
						class="dropdown-item dropdown-toggle">Assunto/Classificação Documental</a>
						<ul class="dropdown-menu">
							<c:if
								test="${f:podeUtilizarServicoPorConfiguracao(titular,lotaTitular,'SIGA:Sistema Integrado de Gestão Administrativa;DOC:Módulo de Documentos;REL:Gerar relatórios;CLSD:Assunto/Classificação Documental;CLASS:Relação de classificações')}">
								<li><a class="dropdown-item"
							...
							<c:if
								test="${f:podeUtilizarServicoPorConfiguracao(titular,lotaTitular,'SIGA:Sistema Integrado de Gestão Administrativa;DOC:Módulo de Documentos;REL:Gerar relatórios;CLSD:Assunto/Classificação Documental;DOCS:Relação de documentos classificados')}">
