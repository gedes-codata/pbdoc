...
var providerPassword = {
	...
	inicializar : function(cont) {
		try {
			var senhaDialog = $(''
				+ '<div class="modal fade" tabindex="-1" role="dialog" id="senhaDialog">'
				+ '  <div class="modal-dialog modal-dialog-centered" role="document">'
				+ '    <div class="modal-content">'
				+ '      <form id="assinarDocForm">'
				...
				+ '          <button type="submit" id="senhaOk" class="btn btn-primary">OK</button>'
				+ '        </div>'
				+ '      </form>'
				+ '    </div>'
				+ '  </div>'
			...
			senhaDialog.on('shown.bs.modal', function () {
				...
				$('form#assinarDocForm').submit(function(event) {
...
var process = {
	...
	run : function() {
		...
		var progressDialog = $(''
			+ '<div class="modal fade" tabindex="-1" role="dialog" id="progressDialog">'
			+ '  <div class="modal-dialog" role="document">'
			+ '    <div class="modal-content">'
			+ '      <div class="modal-header"><h5 class="modal-title" id="exampleModalLabel">Assinatura Digital (' + provider.nome + ')</h5><button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button></div>'
